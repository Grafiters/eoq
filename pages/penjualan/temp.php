                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          foreach ($items as $item) {
                            ...
                            $name = $item[2];
                            $jml = $item[5];
                            echo "<option value='$itemId' jumlah='$jml'>$name</option>";
                          }
                          ?>
                          </select>
                        </td>
                        <td>
                          ...
                          foreach ($items as $item) {
                            ...
                            echo "<option value='$priceId' price='$price' jumlah='$jml'>$harga</option>";
                          }
                          ?>
                          </select>
                        </td>
                        ...
                        <td>
                          <button class="btn btn-sm btn-success" type="submit" name="update" id="btn-submit">tambah</button>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="5"></td>
                        <td>
                          <a class="btn btn-sm btn-warning" href="/eoq/backend/penjualan/deletePenjualan.php?id=<?= $_GET['id'] ?>">
                            batal
                          </a>
