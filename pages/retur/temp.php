...
$query = "
  SELECT
    ...
    pivot_retur.id AS id,
    pivot_retur.total AS jumlah,
    pivot_retur.retur_id AS pembelian,
    pivot_retur.status AS status,
    pivot_retur.total * barang.harga AS total
  FROM pivot_retur
  INNER JOIN barang
  ON pivot_retur.barang_id=barang.id
  WHERE pivot_retur.retur_id = $id;
";
                ...
                <div class="row align-items-end">
                  ...
                  <div class="col">
                    <div class="form-group row">
                      <label class="col-form-label col-sm-4" for="">Kode Retur</label>
                      <div class="col-sm-8">
                        <input class="form-control" type="text" value="<?= $pembelian['kode'] ?>" disabled>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-form-label col-sm-4" for="">Tanggal Retur</label>
                      <div class="col-sm-8">
                ...
                <table class="table table-hover table-borderless text-center">
                  ...
                  <tbody>
                    ...
                    while ($beli = $pembelians->fetch_array()) {
                      $stat = ucwords($beli['status']);
                      $idRetur = $beli['pembelian'];
                      $idPivotRetur = $beli['id'];
                      $switchURL = "/eoq/backend/retur/switch.php?id=$idRetur&pivot=$idPivotRetur&tambah=tambah";
                      $btnSwitch = "
                      <form class='d-inline mx-1' action='$switchURL' method='post'>
                      ...
                      ";
                      $btnDelete = "
                      <form class='d-inline mx-1' action='/eoq/backend/retur/deleteItem.php?id=$idRetur&pivot=$idPivotRetur' method='post'>
                        <button type='submit' class='btn btn-danger btn-sm'>
                          delete
                        </button>
                      </form>";
                      $actionButtons = $btnSwitch.$btnDelete;
                      echo "<tr>";
                        echo "<td>$i</td>";
                    ...
                    <!-- form tambah belanja -->
                    <form action="/eoq/backend/retur/edit.php?id=<?= $pembelian['id'] ?>" method="POST">
                      ...
                      <tr>
                        <td colspan="6"></td>
                        <td>
                          <a class="btn btn-sm btn-warning" href="/eoq/backend/retur/delete.php?id=<?= $_GET['id'] ?>">
                            batal
                          </a>
